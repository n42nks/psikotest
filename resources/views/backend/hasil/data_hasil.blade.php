...
function grafik(hasilD, hasilI, hasilS, hasilC,hasila, hasilb, hasilc, hasild,hasilta, hasiltb, hasiltc, hasiltd){
    ...
    series: [{
        ...
        Highcharts.chart('chartHasil1', {
    chart: {
        type: 'column'
    },
    title: {
        text: 'Grafik Bahasa Inggris'
    },
    xAxis: {
        categories: [
            'A',
    ...
    series: [{
        name: 'Hasil',
        data: [hasila, hasilb, hasilc, hasild]
    }]
});
