              ...
              <table id="ex1" class="table table-bordered table-striped">
                ...
                @foreach ($petunjuks as $petunjuk)
                  ...
                  <td style="text-align:center;">
                    <a rel="tooltip" title="Edit"  type="button" class="btn btn-warning btn-sm" href="eng/show/{{$petunjuk->id}}">Edit</a>
                    <a data-id="{{$petunjuk->id}}" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger btn-sm del">Hapus</a>
                  </td>
                </tr>
                @php
                    $no++;
