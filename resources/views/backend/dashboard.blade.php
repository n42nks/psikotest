            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    @if (session('role') == '1')
                        ...
                        <li class="nav-item @yield('datahasil')">
                            <a class="nav-link" href="{{ url('admin/datahasil') }}">
                                <i class="fa fa-print"></i> <span>Data Hasil</span>

                            </a>
                        </li>
                        <li class="nav-item @yield('hasilseluruh')">
                            <a class="nav-link" href="{{ url('admin/hasilseluruh') }}">
                                <i class="fa fa-print"></i> <span>Hasil Keseluruhan</span>

                            </a>
                        </li>
                        <li class="nav-item @yield('waktu')">
