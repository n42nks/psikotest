...
<form id="yesform" action="" method="post">
    ...
    <div class="box box-purple">
        <ol class="breadcrumb">
          <li>Test Online</li>
          <li class="active">Analogie Kata</li>
          <!-- <li>Pilihlah jawaban pilihan ganda sesuai dengan kepribadian Anda</li> -->
        </ol>

        <div class="box-header with-border">
          <div class="col-md-12">
            <h2 class="text-center mt-0">Analogie Kata</h2>

              <div class="callout callout-default">
              <h4 class="text-justify">Pada Test ini terdiri dari 3 Kata, dimana diminta mencari kata ke 4 yang cocok dengan kata-kata ke 3, seperti hal kata 1 cocok dengan kata yang ke 2. </h4>
              <h4>Misalnya:</h4>
              <h4>1. Besar:Kecil = Lebar:?</h4>
              <h4>a. Tebal b. Sempit c. Luas d. Tinggi</h4>
              <h4>Jawabanya b. Sempit</h4>
              </div>
