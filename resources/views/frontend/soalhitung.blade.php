...
<form id="yesform" action="" method="post">
    ...
    <div class="box box-purple">
        <ol class="breadcrumb">
          <li>Test Online</li>
          <li class="active">Analogie Hitungan</li>
          <!-- <li>Pilihlah jawaban pilihan ganda sesuai dengan kepribadian Anda</li> -->
        </ol>

        <div class="box-header with-border">
          <div class="col-md-12">
            <h2 class="text-center mt-0">Analogie Hitungan</h2>
              <div class="callout callout-default">
              <h4 class="text-justify">Pada Test ini diuji kemampuan analogie hitungan( Deret ukur, Deret Hitung atau Kombinasinya), Temukan kunci penyelesainnya. </h4>
              <h4>Misalnya:</h4>
              <h4>I. 2 4 6 8 10 12 14 .. ..</h4>
              <p> Dari contoh diatas deret hitungan dengan penambahan (+2) dan seterusnya hingga angka terakhir (14), sehingga ditulis 16 (14+2) dan 18 (16+2), Kedua jawaban ditulis segaris.</p>
              </div>
