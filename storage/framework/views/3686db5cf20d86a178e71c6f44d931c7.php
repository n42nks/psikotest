...
<?php $__env->startSection('datahasil/eng','active'); ?>
        ...
        <form method="POST" action="" id="frmnpm" style="padding:5px 10px 0px 40px;">
            ...
            <div class="col-sm-5">
                ...
                <select class="form-control select2" name="npm" id="npm" style="width: 100%;">
                  ...
                  <?php $__currentLoopData = $pendaftar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script type="text/javascript" src="<?php echo e(asset('js/grafik.js')); ?>"></script>
...
$(document).ready(function(){
    ...
    $("#btnLihatnpm").click(function(e){
        ...
        // alert($('#ta').val());
        $.ajax({
            url:"<?php echo e(url('admin/eng/hasil/ceknpm')); ?>",
            type:'POST',
            data:{npm:$("#npm").val()},
            success:function(r){
                console.log(r);
...
<?php echo $__env->make('backend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views\backend\hasil\data_hasil_eng.blade.php ENDPATH**/ ?>