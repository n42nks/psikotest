        ...
        <div class="card-modern">
            ...
            <div class="card-body-modern">
                ...
                <div class="info-item">
                    ...
                    <strong><?php echo e(session()->get('npm')); ?></strong>
                </div>

                <div class="info-item">
                    <span>Nama Peserta</span>
                    <strong><?php echo e(session()->get('nama')); ?></strong>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:15px; overflow:hidden;">
                ...
                <div class="modal-footer" style="border:none; display:flex; gap:10px;">
                    ...
                    <a href="<?php echo e(url('/tpa/1')); ?>" class="btn btn-success" style="flex:1;">
                        🚀 Mulai Tes
                    </a>
...
<?php echo $__env->make('frontend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views/frontend/tpa/index.blade.php ENDPATH**/ ?>