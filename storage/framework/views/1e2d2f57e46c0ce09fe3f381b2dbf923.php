        ...
        <div class="col-md-4">
            <div class="card-profile-modern text-center">
                ...
                <div class="info">
                    ...
                    <div><span>Kota</span><b><?php echo e(session()->get('tmp')); ?></b></div>
                </div>
        ...
        <div class="col-md-8">
            <div class="card-instruction">
                ...
                <div class="body-instruction">
                    ...
                    <!-- BUTTON -->
                    <a href="<?php echo e(url('/english/2')); ?>" class="btn-start">
                        🚀 Kerjakan Sekarang
                    </a>
...
<?php echo $__env->make('frontend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views\frontend\engliskonfirmasi.blade.php ENDPATH**/ ?>