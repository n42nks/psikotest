         ...
         <div class="col-md-7">
          ...
          <div class="box box-primary">
              ...
              <div class="callout callout-default" style="margin-left: 10px;text-align:center;">
                ...
                <a href="<?php echo e(url('/kata/3')); ?>"><button class="btn btn-primary btn-block" sty><h4>Kerjakan Sekarang</h4></button></a>
...
<?php echo $__env->make('frontend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views/frontend/konfirmasi.blade.php ENDPATH**/ ?>