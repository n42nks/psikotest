            ...
            <form action="<?php echo e(route('tambahsoal')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <input type="text" readonly="" class="form-control" id="id_soal" name="id_soal"
                                    value="<?php $__currentLoopData = $Soal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($data->id_soal + 1); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label>Soal</label>
                        <textarea type="text" class="form-control" id="soal" name="soal" class="form-control" rows="3"
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <textarea style="width: 50%;" type="text" class="form-control" id="A" name="A" required></textarea>
                                <script>
                                    CKEDITOR.replace('A', {
                                        filebrowserBrowseUrl: "<?php echo e(asset('ckeditor/kcfinder/browse.php?type=files')); ?>",
                                        filebrowserImageBrowseUrl: "<?php echo e(asset('ckeditor/kcfinder/browse.php?type=images')); ?>",
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control" id="B" name="B" required></textarea>
                                <script>
                                    CKEDITOR.replace('B', {
                                        filebrowserBrowseUrl: "<?php echo e(asset('ckeditor/kcfinder/browse.php?type=files')); ?>",
                                        filebrowserImageBrowseUrl: "<?php echo e(asset('ckeditor/kcfinder/browse.php?type=images')); ?>",
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control" id="C" name="C" required></textarea>
                                <script>
                                    CKEDITOR.replace('C', {
                                        filebrowserBrowseUrl: "<?php echo e(asset('ckeditor/kcfinder/browse.php?type=files')); ?>",
                                        filebrowserImageBrowseUrl: "<?php echo e(asset('ckeditor/kcfinder/browse.php?type=images')); ?>",
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control" id="D" name="D" required></textarea>
                                <script>
                                    CKEDITOR.replace('D', {
                                        filebrowserBrowseUrl: "<?php echo e(asset('ckeditor/kcfinder/browse.php?type=files')); ?>",
                                        filebrowserImageBrowseUrl: "<?php echo e(asset('ckeditor/kcfinder/browse.php?type=images')); ?>",
...
<?php echo $__env->make('backend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\psikotest\resources\views/backend/DataSoalTpa/TambahSoal.blade.php ENDPATH**/ ?>