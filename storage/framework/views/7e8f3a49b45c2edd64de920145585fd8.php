            ...
            <div class="box-body">
              ...
              <table id="ex1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th width="auto" style="text-align: center;">Petunjuk</th>
                ...
                <?php $__currentLoopData = $petunjuks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $petunjuk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <td><?php echo e($petunjuk->id); ?></td>
                  <td><?php echo e($petunjuk->petunjuk); ?></td>
                  <td style="text-align:center;">
                    <a rel="tooltip" title="Edit"  type="button" class="btn btn-warning btn-sm" href="eng/show/<?php echo e($petunjuk->id); ?>">Edit</a>
                    <a data-id="<?php echo e($petunjuk->id); ?>" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger btn-sm del">Hapus</a>
                  </td>
                </tr>
                <?php
                    $no++;
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">          
                          ...
                          <h4 class="modal-title">Konfirmasi Hapus Data Petunjuk</h4>
                        </div>
                        ...
                        <div class="modal-body">
                          <form action="soal/delete" method="POST">
                            <div class="col">
                              <label for="text">Apakah ingin menghapus petunjuk</label>
                            </div>
...
<?php $__env->startSection('js'); ?>
    <script>
      ...
      $(document).on("click", ".btn.btn-danger.btn-sm.del", function () {
        var id = $(this).data('id');
        $("#del").attr("href", 'eng/petunjuk/' + id + '/delete')
      });
    </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views\backend\DataSoal\data_petunjuk_eng.blade.php ENDPATH**/ ?>