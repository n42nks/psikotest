...
$(document).ready(function() {
  ...
  var menit = "<?php echo e(session('menit')); ?>";
    ...
    $('#yes').click(function() {
      ...
      $('#yesform').attr('action', "<?php echo e(url('/storetpa')); ?>");
    });
...
<?php echo $__env->make('frontend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views\frontend\soalnalar.blade.php ENDPATH**/ ?>