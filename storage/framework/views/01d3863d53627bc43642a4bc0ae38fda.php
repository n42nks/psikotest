        ...
        <div class="box">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                  <td style="width:10%"><?php echo e($data->id_soal); ?></td>
                  <td style="width:50%"><?php echo $data->soal; ?></td>
                  <td style="width:20%"><?php echo e($data->jawaban); ?></td>
                  <td>
                    <a href="soal-tpa/<?php echo e($data->id_soal); ?>/edit"><button type="button" name="button" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span>Edit</button></a>
                    <button type="button" class="btn btn-danger" data-id="<?php echo e($data->id_soal); ?>"  data-toggle="modal" data-target="#modal-delete">
                      Hapus
                    </button>
                  </td>
...
<?php echo $__env->make('backend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views\backend\DataSoalTpa\DaftarSoal.blade.php ENDPATH**/ ?>