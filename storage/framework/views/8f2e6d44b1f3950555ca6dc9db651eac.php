...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(url('admin/reading/eng/save')); ?>" method="POST">
        ...
        <div class="form-group">
          <label>Cerita</label>
          <select name="id_cerita" id="id_cerita" class="form-control">
            <?php $__currentLoopData = $ceritas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cerita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option <?php echo e($data->id_cerita == $cerita->id ? 'selected' : ''); ?> value="<?php echo e($cerita->id); ?>"><?php echo e($cerita->id); ?>. <?php echo e($cerita->cerita); ?></option>
...
<?php echo $__env->make('backend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views\backend\DataSoal\data_reading_eng_add.blade.php ENDPATH**/ ?>