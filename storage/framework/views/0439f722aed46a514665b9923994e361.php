    ...
    <form id="yesform" action="<?php echo e(url('/storetpa')); ?>" method="POST">
        ...
        <div class="box box-purple">
            ...
            <div class="box-header header-modern">
                <h4 class="title">Tes Intelegensi Umum</h4>
...
<?php echo $__env->make('frontend/dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\psikotest\resources\views\frontend\soaleng.blade.php ENDPATH**/ ?>